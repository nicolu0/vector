...
<div class="flex h-dvh w-full overflow-hidden bg-stone-50 text-stone-900">
	...
	>
		<button
			...
			class="flex h-7 w-7 items-center justify-center rounded-md text-stone-700 transition opacity-80 hover:opacity-90 hover:bg-stone-200 hover:text-stone-900 duration-200 ease-out focus:outline-none select-none"
