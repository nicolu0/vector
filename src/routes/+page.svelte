				...
				<div class="space-y-4">
                    ...
                    <div class="rounded-xl border border-stone-200 bg-white p-4 text-[14px] leading-relaxed text-stone-800">
                        ...
                        <p class="text-stone-700">
                            ...
                            <a href="/" class="inline-flex items-center gap-1 font-medium text-stone-900 underline decoration-stone-300 underline-offset-2 hover:text-stone-950 hover:decoration-stone-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-stone-400/60 rounded-sm">
                            ...
                            {#each resources as r}
                                <li>
                                    ...
                                    >
                                        ...
                                        <svg
                                            class="h-4 w-4 shrink-0 opacity-70 -translate-x-1 transition-transform duration-150 group-hover:-translate-x-0.5"
                                            viewBox="0 0 24 24"
                                            fill="none"
                                            stroke="currentColor"
                                            stroke-width="2"
